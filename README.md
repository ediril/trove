...
Trove ships as a Claude Code plugin under `claude/`. It is fully skill-based — there is no system prompt to install, no shell launcher to run. Once the plugin is installed, five slash-command skills drive the workflow:
